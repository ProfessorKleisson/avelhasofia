...
export function AnaxímenesDeMiletoPage() {
    return (
                            ...
                            <div className="relative flex-shrink-0 w-52 h-52 md:w-64 md:h-64">
                                ...
                                <div className="relative w-full h-full rounded-full p-[3px] bg-gradient-to-br from-violet-500 via-purple-600 to-transparent shadow-[0_0_40px_rgba(139,92,246,0.3)]">
                                    <div className="w-full h-full rounded-full overflow-hidden bg-[#13111a] group">
                                        <img
                                            src="/img/filosofia/antiga/autores/Anaxímenes.webp"
                                            alt="ANAXÍMENES DE MILETO"
...
<blockquote class="border-l-4 border-violet-500 pl-8 my-12 py-4 italic text-white/70 text-xl font-light leading-relaxed bg-white/[0.02] pr-8"><strong>"O Ar como Princípio Vital"</strong> | <strong>Escola Jônica</strong><br />> <strong>Período:</strong> c. 585 – c. 525 a.C.<br />> <strong>Local:</strong> Mileto (Jônia - atual Turquia)</blockquote>

 | :--- |
| <strong>Arché</strong> | <strong>Ar</strong> (<em>Aer</em>). Infinito, mas determinado materialmente. |
| <strong>Dinâmica</strong> | <strong>Rarefação</strong> (gera fogo) e <strong>Condensação</strong> (gera vento, água, terra). |
| <strong>Vida</strong> | O ar é alma (<em>psyche</em>) e sopro (<em>pneuma</em>) que anima tudo. |
| <strong>Cosmologia</strong> | Terra plana flutuando sobre o ar. |
| <strong>Legado</strong> | Explicação dos estados da matéria por densidade. |
                    ...
                    <section class="mt-8">
                        <div class="bg-white/[0.02] border border-white/5 p-4 rounded-xl overflow-hidden group">
                            <img src="/img/filosofia/antiga/infograficos/Anaxímenes.png" alt="Infográfico Anaxímenes" class="w-full h-auto hover:scale-[1.02] transition-transform duration-700" />
                        </div>
